...
#ifdef SKILLS_TESTING_TEMP //14050 - todos
	vWorlds.push_back( new CWorld( WORLDID_None,	 "None",		0x00000000,					0,	   "",	       "",              "",  0x00000000,    0x00000000 ) ); // edit chaos
	vWorlds.push_back( new CWorld( WORLDID_Seasonal, "Seasonal",	ulFPTSeasonal, 14050, GAME_NAME, "PT EU", "Pristontale.eu", ulFPTMain,		ulFPTMain ) );
#else
	vWorlds.push_back( new CWorld( WORLDID_None,	 "None",		0x00000000,		0,	   "",	"", "", 0x00000000, 0x00000000 ) ); // edit chaos
	vWorlds.push_back( new CWorld( WORLDID_Babel,	 "Babel",	 ulFPTMain, 14050, GAME_NAME, "PT EU", "Pristontale.eu", ulFPTMain,		ulFPTMain ) );
	vWorlds.push_back( new CWorld( WORLDID_Seasonal, "Seasonal", ulFPTSeasonal, 14050, GAME_NAME, "PT EU", "Pristontale.eu", ulFPTSeasonal, ulFPTSeasonal ) );
#endif

	vWorlds.push_back( new CWorld( WORLDID_Dev,		"Dev",		ulFPTDev, 14050, GAME_NAME, "PT EU", "Pristontale.eu", ulFPTDev,		ulFPTDev ) );
