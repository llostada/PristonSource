...
#define IP_FORTRESS_MAIN			"186.212.90.52"		// offIcial 54.36.127.45
#define IP_FORTRESS_SEASONAL 		"186.212.90.52"		//"51.195.60.124" Seasonal box	// 37.187.180.4 Test box
#define IP_FORTRESS_DEV 			"186.212.90.52"		// Local only 127.0.0.1
...
static int iGamePort = 14050; //14050
