...
void CLua::Register( std::string strName, void * pFunction )
{
...
void CLua::DoFile( std::string strFilePath, bool bIgnoreEncrypt )
{
	if( bIgnoreEncrypt )
	{
...
std::string CLua::ReadParamString( LuaState * pLuaState, int iParam )
{
