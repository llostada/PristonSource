...
CWorld::CWorld( EWorldID _iWorldID, std::string _strName, unsigned long _lIP, USHORT _uPort, std::string _strGameName, std::string _strShortGameName, std::string _strWebsite, unsigned long _lIP2, unsigned long _lIP3 )
{
	iWorldID			= _iWorldID;
	strName				= _strName;
	lIP					= _lIP;
