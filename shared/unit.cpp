...
// ====== Static function pointer addresses (converted from header) ======
#if defined(_GAME)
DWORD UnitData::pfnCloseUnitData = 0x0041F3C0;
DWORD UnitData::pfnHandleBufferData = 0x00423440;
DWORD UnitData::pfnAnimate = 0x00429680;
DWORD UnitData::pfnSetNextTarget = 0x00000000;
DWORD UnitData::pfnMain = 0x0043CB20;
DWORD UnitData::pfnSetPosition = 0x0041F600;
DWORD UnitData::pfnSetAngleByPosition = 0x00000000;
DWORD UnitData::pfnLoadModel = 0x00000000;
DWORD UnitData::pfnRender = 0x00429AF0;
DWORD UnitData::pfnGetAnimAttackPosition = 0x004294D0;
DWORD UnitData::pfnInit = 0x0041EF00;
DWORD UnitData::pfnChangeAnimationID = 0x0041FA04;
DWORD UnitData::pfnUpdateAttack = 0x0042B600;
DWORD UnitData::pfnMoveAngle = 0x0044FFB4;
DWORD UnitData::pfnCheckShootingTest = 0x0041FDB0;
DWORD UnitData::pfnSetTarget = 0x00433E20;
DWORD UnitData::pfnSetTargetEx = 0x00000000;
DWORD UnitData::pfnBeginSkill = 0x0042CB40;
DWORD UnitData::pfnResetEnergyGraph = 0x0045D910;
#elif defined(_SERVER)
DWORD UnitData::pfnCloseUnitData = 0x004167A0;
DWORD UnitData::pfnHandleBufferData = 0x0041B780;
DWORD UnitData::pfnAnimate = 0x00416E30;
DWORD UnitData::pfnSetNextTarget = 0x00416A90;
DWORD UnitData::pfnMain = 0x00429930;
DWORD UnitData::pfnSetPosition = 0x00000000;
DWORD UnitData::pfnSetAngleByPosition = 0x00416A50;
DWORD UnitData::pfnLoadModel = 0x00429350;
DWORD UnitData::pfnRender = 0x00000000;
DWORD UnitData::pfnGetAnimAttackPosition = 0x00000000;
DWORD UnitData::pfnInit = 0x00000000;
DWORD UnitData::pfnChangeAnimationID = 0x00000000;
DWORD UnitData::pfnUpdateAttack = 0x00000000;
DWORD UnitData::pfnMoveAngle = 0x0041EB40;
DWORD UnitData::pfnCheckShootingTest = 0x00000000;
DWORD UnitData::pfnSetTarget = 0x0041E670;
DWORD UnitData::pfnSetTargetEx = 0x004454A0;
DWORD UnitData::pfnBeginSkill = 0x00000000;
DWORD UnitData::pfnResetEnergyGraph = 0x00000000;
#else
DWORD UnitData::pfnCloseUnitData = 0;
DWORD UnitData::pfnHandleBufferData = 0;
DWORD UnitData::pfnAnimate = 0;
DWORD UnitData::pfnSetNextTarget = 0;
DWORD UnitData::pfnMain = 0;
DWORD UnitData::pfnSetPosition = 0;
DWORD UnitData::pfnSetAngleByPosition = 0;
DWORD UnitData::pfnLoadModel = 0;
DWORD UnitData::pfnRender = 0;
DWORD UnitData::pfnGetAnimAttackPosition = 0;
DWORD UnitData::pfnInit = 0;
DWORD UnitData::pfnChangeAnimationID = 0;
DWORD UnitData::pfnUpdateAttack = 0;
DWORD UnitData::pfnMoveAngle = 0;
DWORD UnitData::pfnCheckShootingTest = 0;
DWORD UnitData::pfnSetTarget = 0;
DWORD UnitData::pfnSetTargetEx = 0;
DWORD UnitData::pfnBeginSkill = 0;
DWORD UnitData::pfnResetEnergyGraph = 0;
#endif
// ======================================================================

// Aliases C globais para uso no ASM
extern "C" DWORD g_pfnMain = 0;
extern "C" DWORD g_pfnSetPosition = 0;

// Inicializador fora de struct (evita escopo aninhado acidental)
struct _UnitAsmAliasInit { _UnitAsmAliasInit(); };
static _UnitAsmAliasInit _unitAsmAliasInit;

_UnitAsmAliasInit::_UnitAsmAliasInit() {
	g_pfnMain = UnitData::GetPfnMain();
	g_pfnSetPosition = UnitData::GetPfnSetPosition();
}
