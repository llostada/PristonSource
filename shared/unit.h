...
private:
...
#if defined(_GAME)
	static DWORD pfnCloseUnitData;
	static DWORD pfnHandleBufferData;
	static DWORD pfnAnimate;
	static DWORD pfnSetNextTarget;
	static DWORD pfnMain;
	static DWORD pfnSetPosition;
	static DWORD pfnSetAngleByPosition;
	static DWORD pfnLoadModel;
	static DWORD pfnRender;
	static DWORD pfnGetAnimAttackPosition;	//Leaked: GetAttackPoint
	static DWORD pfnInit;
	static DWORD pfnChangeAnimationID;
	static DWORD pfnUpdateAttack;	//int smCHAR::PlayAttack( int EventFlag )
	static DWORD pfnMoveAngle;	//int smCHAR::MoveAngle2( int step )
	static DWORD pfnCheckShootingTest;	//int smCHAR::CheckShootingTest(smCHAR *lpChrTarget)
	static DWORD pfnSetTarget;
	static DWORD pfnSetTargetEx;
	static DWORD pfnBeginSkill;
	static DWORD pfnResetEnergyGraph;
	...
	static DWORD pfnLoadModel;
	static DWORD pfnRender;
	static DWORD pfnGetAnimAttackPosition;
	static DWORD pfnInit;
	static DWORD pfnChangeAnimationID;
	static DWORD pfnUpdateAttack;
	static DWORD pfnMoveAngle;
	static DWORD pfnCheckShootingTest;
	static DWORD pfnSetTarget;
	static DWORD pfnSetTargetEx;
	static DWORD pfnBeginSkill;
	static DWORD pfnResetEnergyGraph;
...
public:
	//Attributes
	DWORD							dwHeader;
	static DWORD GetPfnSetPosition() { return pfnSetPosition; }
	BOOL                            bVisible;
	...
	BOOL							Render();
	// Getter público para uso no init do alias ASM
	static DWORD GetPfnMain() { return pfnMain; }
